...
import hung.jiawa.R;
import hung.jiawa.presenter.IPersonalKeepPresenter;
import hung.jiawa.presenter.PersonalKeepPresenterCompl;
import hung.jiawa.view.IPersonalKeepView;

public class PersonalKeepActivity extends AppCompatActivity implements IPersonalKeepView, View.OnClickListener, RecyclerRefreshLayout.OnRefreshListener {
    ...
    IPersonalKeepPresenter personalKeepPresenter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personalKeepPresenter = new PersonalKeepPresenterCompl(this,this);
        personalKeepPresenter.initRecyclerView(article_list);
        //personalKeepPresenter.getFavorit();
    }
